...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/LYd8TboNCJ)
...
```sh
npx nx serve cmma-frontend
```

To create a production bundle:

```sh
npx nx build cmma-frontend
```

To see all available targets to run for a project, run:

```sh
npx nx show project cmma-frontend
```
